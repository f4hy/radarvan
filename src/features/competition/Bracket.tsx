...
import { useIsTournamentAdmin } from "../../lib/AuthContext"
...
import { BILLED_QUERY_OPTIONS } from "../../lib/queryClient"
import { usePlayerNav } from "../../lib/links"
    ...
    <>
      ...
      <DialogContent>
        ...
        {!loading && games.length > 0 && (
          <Stack>
            {games.map((g, idx) => (
              <MatchCard key={g.id} match={g} idx={idx} />
            ))}
          </Stack>
        )}
